      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="餐品编号" prop="canpinbianhao">
          <el-input v-model="ruleForm.canpinbianhao" 
              placeholder="餐品编号" clearable  :readonly="ro.canpinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="餐品编号" prop="canpinbianhao">
              <el-input v-model="ruleForm.canpinbianhao" 
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `huodongdingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huodongdingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
