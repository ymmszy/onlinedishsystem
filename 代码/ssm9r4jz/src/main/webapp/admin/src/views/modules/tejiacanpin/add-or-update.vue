<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="餐品编号" prop="canpinbianhao">
            <el-input v-model="ruleForm.canpinbianhao" 
                placeholder="餐品编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.canpinbianhao" label="餐品编号" prop="canpinbianhao">
              <el-input v-model="ruleForm.canpinbianhao" 
                placeholder="餐品编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="餐品名称" prop="canpinmingcheng">
          <el-input v-model="ruleForm.canpinmingcheng" 
              placeholder="餐品名称" clearable  :readonly="ro.canpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="餐品名称" prop="canpinmingcheng">
              <el-input v-model="ruleForm.canpinmingcheng" 
                placeholder="餐品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="餐品分类" prop="canpinfenlei">
          <el-select v-model="ruleForm.canpinfenlei" placeholder="请选择餐品分类">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.canpinfenlei"
                placeholder="餐品分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原价格" prop="yuanjiage">
          <el-input v-model="ruleForm.yuanjiage" 
              placeholder="原价格" clearable  :readonly="ro.yuanjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="原价格" prop="yuanjiage">
              <el-input v-model="ruleForm.yuanjiage" 
                placeholder="原价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动价格" prop="huodongjiage">
          <el-input v-model="ruleForm.huodongjiage" 
              placeholder="活动价格" clearable  :readonly="ro.huodongjiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动价格" prop="huodongjiage">
              <el-input v-model="ruleForm.huodongjiage" 
                placeholder="活动价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tejiacanpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tejiacanpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
